...
const FifthSection = () => {
  return (
    <div>
        <section className='section-bg-5 min-h-dvh bg-overlay bg-blend-overlay flex justify-center items-center'>
                <div className=' space-y-4 max-w-3xl w-full z-10 '>
                    ...
                    <h1 className='text-4xl leading mb-4 text-pretty tracking-wide text-white text-center font-bold'>Sign up to explore <br/> world best ideas</h1>
                    ...
                    <div className=' my-7 text-center text-white text-sm'>
                      ...
                      {/* <p className='mt-10'>Are you a Business ? <Link href={'/auth/login'}>Get Started here</Link></p> */}
