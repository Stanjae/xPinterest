...
const DeleteCommentModal = ({handleDelete, title}:any) => {
  ...
  return (
    <>
      <Button onPress={onOpen} size='sm' variant="light" radius='full' isIconOnly>
          <TrashIcon className='h-4 text-gray-500 w-4'/>
      </Button>
